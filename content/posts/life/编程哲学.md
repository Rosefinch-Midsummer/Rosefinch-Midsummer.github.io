---
title: "编程哲学"
date: 2025-06-28T18:34:25+08:00
...
“Vibe Coding” 这一术语由 OpenAI 的联合创始人、前特斯拉 AI 负责人 Andrej Karpathy 于 2025 年 2 月首次提出。其核心理念在于：开发者不再需要逐行编写底层代码，而是通过**自然语言向 AI（特别是大型语言模型 LLM）描述需求、意图或期望达成的“氛围”（Vibe）**，由 AI 负责生成相应的代码实现。Karpathy作为AI领域的知名专家，他提出的这一概念迅速引起了开发者社区的广泛关注。Vibe Coding这一术语本身传达了一种”氛围”或”感觉”，象征着一种更加自由、直观的编程方式，开发者可以完全专注于创意和概念，而不必被繁琐的编码细节所困扰。

这标志着一种从**指令式编程（告诉计算机“如何做”）**向**意图驱动编程（告诉计算机“做什么”）**的转变。开发者将更多精力聚焦于问题的定义、需求的阐述和最终结果的验证，而非陷入繁琐的语法细节和实现逻辑。
...
Vibe Coding 对经验丰富的开发者而言，既是机遇也是挑战。它并非要取代开发者，而是**重塑开发者的角色和技能栈**：
...
文章作者: [Eryx Lee](https://blog.agiexplained.com/)

文章链接: [https://blog.agiexplained.com/2025/03/31/vibe-coding/](https://blog.agiexplained.com/2025/03/31/vibe-coding/)


# 编程之道 | THE WAY OF CODE
...
## 编程智慧总结 | Programming Wisdom Summary
...
**项目地址：** [https://www.thewayofcode.com](https://www.thewayofcode.com/)

---

_"道可道，非恒道。码可码，非恒码。"_

_"The code that can be named is not the eternal code."_
...
Inspired by "THE WAY OF CODE" based on Lao Tzu, adapted by Rick Rubin

[www.thewayofcode.cn/](https://www.thewayofcode.cn/ "https://www.thewayofcode.cn/")
